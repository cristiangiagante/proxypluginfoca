...
namespace FocaPluginExample
{
    public class Plugin
    {
        private string _name = "Foca Plugin Proxy";
        private string _description = "Set Windows global proxy configuration from FOCA";
        ...
        public Plugin()
        {
            ...
            toolStripMenuItem1.Image = Properties.Resources.proxy_img;
